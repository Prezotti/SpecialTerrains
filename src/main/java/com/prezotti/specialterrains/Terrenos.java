...
public class Terrenos {
    ...
    public Terrenos(String jogador, Types tipo, Location pos1, Location pos2, List<String> amigos,
                    boolean pvp) {
    ...
    public static List<Terrenos> getAll() {
        return new ArrayList<>(Terrains.instance.TerrenosCache.values());
    }
    ...
    public void save() {
        Terrains.getInstance().DataFile.set("Terrenos." + getJogador() + ".Tipo", getTipo().toString());
        Terrains.getInstance().DataFile.set("Terrenos." + getJogador() + ".Pos1", serializeLoc(getPos1()));
        Terrains.getInstance().DataFile.set("Terrenos." + getJogador() + ".Pos2", serializeLoc(getPos2()));
        Terrains.getInstance().DataFile.set("Terrenos." + getJogador() + ".Amigos", getAmigos());
        Terrains.getInstance().DataFile.set("Terrenos." + getJogador() + ".Pvp", isPvp());
    }
